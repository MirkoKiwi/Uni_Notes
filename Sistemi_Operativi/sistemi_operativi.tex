...
\begin{document}
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=8cm]{three-processes_SO.png}
		\caption*{}
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=14.5cm]{five-state-process-model_SO.png}
		\caption*{}
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=15cm]{process-image_SO.png}
		\caption*{}
	...
	\begin{wrapfigure}{r}{0.20\textwidth}
		\centering
		\includegraphics[width=3.8cm]{process-image-segments_SO.png}
		\caption*{}
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=4cm]{process-control-block_SO.png}
		%\caption*{}
...
%	\section*{Lezione 4 (...)}
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=8.2cm]{queueing-diagram_SO.png}
		\caption*{}
	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}{.3\textwidth}
			\centering
			\includegraphics[width=4cm]{levels-of-scheduling_SO.png}
			\caption*{}
			\label{fig:levels-of-scheduling}
		\end{subfigure}%
		\begin{subfigure}{.7\textwidth}
			\centering
			\includegraphics[width=12cm]{queueing-diagram-scheduling_SO.png}
			\caption*{}
