...
% between \documentclass and \begin{document}.
	...
	\begin{document}
		...
		\begin{figure}[ht]
			\centering
			\includegraphics[width=8cm]{elec-field-lines.png}
		...
		\begin{wrapfigure}{r}{0.25\textwidth}
			\centering
			\includegraphics[width=3.5cm]{elec-dipole.png}
		...
		\begin{wrapfigure}{r}{0.25\textwidth}
			\centering
			\includegraphics[width=6.07cm]{elec-line-charge.png}
		...
		\begin{figure}
			\centering
			\includegraphics[width=10cm]{electric-line-charge.png}
			\caption*{Figure 4}
		...
		\begin{wrapfigure}{r}{0.25\textwidth}
			\centering
			\includegraphics[width=3cm]{elec-charged-disk.png}
		...
		\begin{figure}
			\centering
			\includegraphics[width=5cm]{potential-dipole.png}
		...
		\begin{figure}[!htb]  % force figure under subsection
			\centering
			\includegraphics[width=10cm,height=3.5cm]{elec-veloc-flux.png}
		...
		\begin{wrapfigure}{r}{0.15\textwidth}
			\includegraphics[width=4.5cm,height=7cm]{gaussian-elec-field.png}
		...
		\begin{figure}[!htb]  % force figure under subsection
			\centering
			\includegraphics[width=8cm]{closed-cylinder.png}
			\caption*{}
		...
		\begin{wrapfigure}{r}{0.17\textwidth}
			\centering
			\includegraphics[width=4cm]{gaussian-surf-lines.png}
			\caption*{Figure 8}
