...
% between \documentclass and \begin{document}.
	...
	\begin{document}
		...
		If an excess charge is placed on an isolated conductor, that amount of charge will move entirely to the surface of the conductor, thus none of the excess charge will be found within the body of the conductor ( Given by the fact that cahrges with same sign repel one another ). GITHUBTESTCOMMITTEST
